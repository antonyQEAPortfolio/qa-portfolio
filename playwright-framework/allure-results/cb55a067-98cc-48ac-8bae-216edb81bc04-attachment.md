...
Call log:
  - waiting for locator('button[routerlink*=\'myorders\']')
    - waiting for" https://rahulshettyacademy.com/client/auth/login" navigation to finish...
    - navigated to "https://rahulshettyacademy.com/client/auth/login"

    at C:\Users\anton\OneDrive\Documents\GitHub\qa-portfolio\playwright-framework\tests\createOrderThroughApi.spec.js:22:58
```
